...
ax = sns.barplot(x='recovery', y='file', hue="method", data=df, orient='h',gap=0.2, width=0.7)
...
ax.set_xlabel('recovery rate', fontsize=font_size)
...
plt.savefig('t4_yyc_diffile.png')
