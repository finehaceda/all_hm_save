...
df = pd.read_excel('plot.xlsx', sheet_name='endecode_rate3')
...
ax1 = sns.barplot(x='method', y='encode_time', data=df, ax=axes[0])
...
ax1.set_ylabel('encode time', fontsize=font_size)
...
plt.savefig('endecode_nanopone.png')
