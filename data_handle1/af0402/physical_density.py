...
df = pd.read_excel('plot.xlsx', sheet_name='physical_den')
...
ax = sns.barplot(x='seq', y='density', hue="method", data=df)
# ax = sns.catplot(
#     df, kind="bar",
...
ax.set_ylabel('physical density(bit/m³)', fontsize=font_size)
