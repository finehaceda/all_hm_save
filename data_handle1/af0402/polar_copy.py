...
# df = pd.read_excel('plot.xlsx', sheet_name='polar_copy5_10')
df = pd.read_excel('plot.xlsx', sheet_name='polar_copy')
...
g = sns.catplot(
    df, kind="bar",
    x="copy", y="recovery", hue="method", col="frozen_bit",
...
plt.savefig('polar_copy5_6_8_10.png')
