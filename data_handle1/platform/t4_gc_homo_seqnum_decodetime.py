...
axes[0,0].set_xlabel('(a) density(nt/s)', fontproperties=prop, fontsize=25, labelpad=20)
...
# df.to_csv('plot.csv', index=False, encoding='utf-8')
# df = pd.read_csv('plot.csv', encoding='utf-8')
# ax = sns.barplot(x='time0503', y='method', data=df, orient='h', width=0.6, palette="muted", ax=axes[0,1])
...
df.to_csv('plot.csv', index=False, encoding='utf-8')
df = pd.read_csv('plot.csv', encoding='utf-8')
ax = sns.barplot(x='avg_time_4files', y='method', data=df, orient='h', width=0.6, palette="muted", ax=axes[0,1])
...
axes[0,1].set_xlabel('(b) average encode time(s)', fontproperties=prop, fontsize=25, labelpad=20)
...
# axes[1,0].set_xlabel('（c）GC含量对比', fontproperties=prop, fontsize=25, labelpad=20)
axes[1,0].set_xlabel('(c) GC content', fontproperties=prop, fontsize=25, labelpad=20)
...
axes[1,1].set_xlabel('(d) max homopolymer', fontproperties=prop, fontsize=25, labelpad=20)
...
plt.tight_layout()
# plt.savefig('t4_density_decodetime_gc_homo_merge.png')
plt.savefig('t4_density_encodetime_gc_homo_merge.png')
