...
axes[0].set_ylabel('base recovery rate', fontsize=font_size)
...
axes[1].set_ylabel('base recovery rate', fontsize=font_size)
...
plt.tight_layout()
plt.savefig('t3_bma_rev_rate.png')
