...
df = pd.read_excel('plot.xlsx', sheet_name='t3_3')
...
# ax1 = sns.barplot(x='success', y='data', hue="method", orient='h', data=df[0:4], ax=axes[0])
...
# ax2 = sns.barplot(x='data', y='success', hue="method", orient='h', data=df[4:8], ax=axes[1])
...
plt.tight_layout()
plt.savefig('t3_success_rate.png')
